...
Route::get('/drama/detail', [DramaController::class, 'detail'])->middleware(['frontend.ajax', 'throttle:frontend-api'])->name('drama.detail');
Route::get('/drama/suggest', [DramaController::class, 'searchSuggest'])->middleware(['frontend.ajax', 'throttle:frontend-api'])->name('drama.suggest');
...
Route::middleware(['throttle:frontend-api'])->group(function () {
...
Route::prefix('anime')->name('anime.')->group(function () {
    ...
    Route::get('/ongoing-ajax', [AnimeController::class, 'ongoingAjax'])->middleware(['frontend.ajax', 'throttle:frontend-api'])->name('ongoing.ajax');
    ...
    Route::get('/server/{serverId}', [AnimeController::class, 'server'])->middleware(['frontend.ajax', 'throttle:frontend-api'])->name('server');
});
